...
<script src="/gallery/js/skel.min.js"></script>

<script src="/gallery/js/util.js"></script>
<script src="/gallery/js/main.js"></script>
<template>
<div>
	  
	    <header id="header" class='myHeader' @click='myHeaderAction'>
		...
		myHeaderAction(){
			 this.$nextTick(()=>{
			  if($('.myHeader').hasClass('preview')){
				  $('.myHeader').removeClass('preview')
				  $('.myHeader').show()
			  }else{
                 $('.myHeader').hide()
				 $('.myHeader').addClass('preview')
				 $('.myHeader').show()
			  }
...
@import url(/gallery/css/font-awesome.min.css);
@import url(;data:application/octet-stream;base64,);
/*
	Radius by TEMPLATED
