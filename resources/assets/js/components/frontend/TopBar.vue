	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto" >
	          <li class="nav-item active"><router-link to='/' ><v-btn flat class='myrouter'><v-icon>home</v-icon>Welcome</v-btn></router-link></li>   
            <v-spacer></v-spacer>
            <li class="nav-item"> <router-link to='/galleries' ><v-btn flat class='myrouter'><v-icon>photo_album</v-icon>Galleries</v-btn></router-link></li>
	          <li class="nav-item"><router-link to='/videos'><v-btn flat  class='myrouter'><v-icon>videocam</v-icon>videos</v-btn></router-link></li>
	        </ul>
	      </div>
	    </div>
	  </nav>
...
export default {
   ...
   this.$nextTick(_=>{
        $('#myNav').removeClass('ftco-navbar-light')
        $('#myNav').addClass('fixed-top')
        $('.myrouter').addClass('text-danger')
   ...
   methods:{
     ...
     draw(){
       ...
       if(this.drawer==true){
           this.style={zindex:10000000000000000000000000000000}
       }
       else{
